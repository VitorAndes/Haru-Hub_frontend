...
export function Carousel({ game }: { game: RecentGamesType }) {
  ...
  return (
    ...
    >
      <figure className="max-w-[460px] lg:max-w-[800px] relative">
        <img
          className="rounded-b-2xl lg:rounded-2xl shadow shadow-secondary bg-primary/80 w-full h-[230px] lg:h-[490px]"
      ...
      <div className="flex flex-col gap-4 h-40 lg:h-full max-w-[460px] px-4">
