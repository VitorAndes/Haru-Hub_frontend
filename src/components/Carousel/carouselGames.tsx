...
export function CarouselGames() {
  ...
  return (
    <div className="flex flex-col lg:items-center gap-4 max-w-[460px] lg:max-w-[1280px] overflow-hidden">
      ...
      {isLoading ? (
        ...
        <>
          <div
            className="flex transition-all ease-out duration-700 max-w-[800px] lg:max-w-[1280px]"
            style={{
